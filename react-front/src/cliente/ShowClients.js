                        ...
                        <tbody>
                            { clients.map ( (cliente) => (
                                <tr key={cliente.id}>
                                    ...
                                    <td>
                                        <Link to= {`/edit/${cliente.id}`} className='btn btn-info' ><i className='fa-regular fa-pen-to-square'></i></Link>
                                        <button onClick={ () => deleteClient(cliente.id) } className='btn btn-danger'><i className='fa-solid fa-trash'></i></button>
                                    </td>
                                </tr>
                            ))}
                        </tbody>
